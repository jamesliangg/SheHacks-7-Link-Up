...
## How we built it
We built it with HTML, CSS, and JavaScript. JavaScript is used for going through the calendar files and creating the downloadable calendar file. HTML and CSS are used to style the website in a user friendly way.
